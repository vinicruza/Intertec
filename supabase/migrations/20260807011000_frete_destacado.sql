-- Frete destacado: a flag legada `freight_paid_by_customer` agora identifica
-- que o frete foi rateado nos preços unitários dos itens. O frete continua
-- existindo como custo do pedido; não pode ser subtraído uma segunda vez.
