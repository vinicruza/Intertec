-- Aprovação por selo de margem (07/08/2026)
--
-- Regra operacional:
-- - selo vermelho/amarelo: orçamento vai para aprovação;
-- - selo verde/azul: pode virar pedido direto pelo Comercial.
--
-- A tela esconde ou mostra os botões, mas a trava real precisa ficar no
-- fechamento: o banco recalcula a margem a partir dos snapshots validados e
-- só libera autoaprovação quando a margem oficial fica acima de 50%.
