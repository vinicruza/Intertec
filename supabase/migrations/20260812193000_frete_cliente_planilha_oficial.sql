-- Frete destacado igual à planilha oficial:
-- o frete pago/repassado ao cliente não reduz a margem dos itens, mas o
-- imposto sobre frete continua entrando em linha própria na cascata.
