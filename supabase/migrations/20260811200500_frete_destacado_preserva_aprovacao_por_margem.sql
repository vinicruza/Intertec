-- Mantem a aprovacao automatica por margem junto da nova regra do frete
-- destacado. Desmarcado: frete nao entra na margem. Marcado: frete entra.
...
begin
  ...
  v_margin_pct := case when v_net = 0 then 0 else v_margin / v_net end;
