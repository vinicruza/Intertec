-- DIFAL sobre o total da NF: frete entra na base somente quando destacado.
...
begin
  ...
  v_difal_base := case when v_order.freight_paid_by_customer then v_base_with_freight else v_gross end;
  v_difal := v_difal_rate*v_difal_base;
  ...
  update public.orders set
    ...
    totals_display=jsonb_build_object(
      ...
      'base_difal',round(v_difal_base,2)::text,
