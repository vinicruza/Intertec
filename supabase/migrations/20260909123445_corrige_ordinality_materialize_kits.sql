-- Patricia, 09/09/2026: corrige a materializacao de kit montado ao Gerar Pedido.
-- PostgreSQL nao aceita `with ordinality` junto com lista de definicao de
-- colunas em `jsonb_to_recordset`. A ordem agora vem de `jsonb_array_elements`
-- e os campos do item seguem parseados por `jsonb_to_record`.
